;; Solved with eq_prop=fasle, diverges with eq_prop=true
;; /ag/z3/quic/build/z3 -v:1 -st fixedpoint.print_statistics=true fixedpoint.xform.slice=false fixedpoint.xform.inline_linear=false fixedpoint.xform.inline_eager=false fixedpoint.xform.tail_simplifier_pve=false fixedpoint.engine=spacer  fixedpoint.pdr.validate_result=true fixedpoint.spacer.eq_prop=false fixedpoint.spacer.ground_cti=false  julien1.smt2
;; 
(set-logic HORN)
(declare-rel assign_15_1_75 (Int Int Int Int Int Int ))
(declare-rel while_16_1_113 (Int Int Int Int Int Int ))
...
(declare-rel while_10_1_69 (Int Int Int Int Int Int ))
(declare-rel arrayassign_11_5_57 (Int Int Int Int Int Int ))
; assign_9_1_35 -> start

; assign_12_5_66 -> arrayassign_11_5_57
; while_10_1_69 -> assign_9_1_35
; while_10_1_69 -> assign_12_5_66
; arrayassign_11_5_57 -> while_10_1_69

; assign_15_1_75 -> while_10_1_69

; while_16_1_113 -> assign_15_1_75
; while_16_1_113 -> assign_18_5_110
; assert_17_5_101 -> while_16_1_113
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (and (while_16_1_113 F B E A I J)
           (= B (select G F))
           (= C (select H E))
           (= D (select G F))
           (not (<= I J))
